...
| $\xi^{(3)}_i$  | 0    | 0             | 3             | 4    | 6             | 12            | 16   | 16   | 20            |25|
...
&=-\frac{1}{2}N^3_2(x)+\frac{3}{2}N^3_3(x)+2N^3_4(x)+\frac{7}{2}N^3_5(x)+\frac{17}{2}N^3_6(x)+12N^3_7(x)+12N^3_8(x)+\frac{31}{2}N^3_9(x)+20N^3_{10}(x)
\end{aligned}
$$
